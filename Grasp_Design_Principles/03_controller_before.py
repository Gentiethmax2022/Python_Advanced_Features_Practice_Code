...
class Model:
    ...
    def get_products(self) -> list[tuple[str, float]]:
        products: list[tuple[str, float]] = [(row[0], row[1]) for row in self.cursor.execute(
...
class App(tk.Tk):
    ...
    def create_ui(self) -> None:
        ...
        self.product_list = tk.Listbox(self.frame, height=10, activestyle="none")
